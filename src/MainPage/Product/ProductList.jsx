  ...
  const columns = [
    ...
    },
    {
      ...
      render: () => (
        <>
          <>
            <Link className="me-3" to="/es-ecommerce/product/product-details">
              <img src={EyeIcon} alt="img" />
            </Link>
            <Link className="me-3" to="/es-ecommerce/product/editproduct-product">
        ...
        <div className="content">
          <div className="page-header">
            ...
            <div className="page-btn">
              <Link
                to="/es-ecommerce/product/addproduct-product"
