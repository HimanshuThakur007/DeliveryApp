                  ...
                  <div className="d-flex align-items-center">
                    <div className="status-toggle d-flex align-items-center me-2">
                      ...
                      <label
                        ...
                        onClick={refreshPage}
                      >
                        <Link to="/es-ecommerce/dashboard" className="layout-link">
                          checkbox
                        </Link>{" "}
                      </label>
                    </div>
                  ...
                  <div className="d-flex align-items-center">
                    <div className="status-toggle d-flex align-items-center me-2">
                      ...
                      <label htmlFor={1} className="checktoggle">
                        <a
                          href="https://dreamspos.dreamguystech.com/reactjs/template-rtl/es-ecommerce/dashboard"
                  ...
                  <div className="d-flex align-items-center">
                    <div className="status-toggle d-flex align-items-center me-2">
                      ...
                      <label
                        ...
                        onClick={refreshPage}
                      >
                        <Link to="/es-ecommerce/index-one" className="layout-link">
                          checkbox
                        </Link>{" "}
                      </label>
                    </div>
                  ...
                  <div className="d-flex align-items-center">
                    <div className="status-toggle d-flex align-items-center me-2">
                      ...
                      <label
                        ...
                        onClick={refreshPage}
                      >
                        <Link to="/es-ecommerce/index-two" className="layout-link">
                          checkbox
                        </Link>{" "}
                      </label>
                    </div>
